                ...
                <div class="delivery-form" id="Signup">
                        ...
                        <form onSubmit={sendData} class="row register-form">
                            ...
                            <div class="col-sm-12">
                               ...
                               {/* <div class="form-group">
                                    <span class="form-label">Upload pdf file which contain your vehicle document's images </span>
                                    <input type="file" class="form-control"  name="Files" onChange={handleFile}/>
                                    <p class="error">{formErrors.Files}</p>
</div>*/}

                                <div class="col-sm-12 text-center">
                                    <input type="submit" className="btnD"value="Register" />
                                </div>
                            </div>
                                </form>
                        </div>
