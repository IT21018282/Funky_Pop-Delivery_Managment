		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-3 text-center mb-4">
					<h2 class="heading-section " >Deliveries</h2>
				</div>
          ...
          <tbody>
            ...
            {delivery && delivery.filter(deliveryData=>deliveryData.OrderID.includes(searchID)).map((deliveryData, index) => (
              <tr key={index}>
                ...
                <button type="button" className="btn btnx  btn-dark" onClick={() => {Assign(deliveryData._id); } }>Assign</button> 
                <button type="button" className="btn btnx btn-dark" onClick={(() => DeleteDelivery(deliveryData._id))}><span class="glyphicon">&#xe020;</span></button>
                </td>
