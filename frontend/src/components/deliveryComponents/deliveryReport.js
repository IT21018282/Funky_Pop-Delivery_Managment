    ...
    return (
      ...
      <div className="container" >
       ...
       <div class="row justify-content-center">
                ...
                <a href="/deliveries"  type="button" className="btn btnx btn-dark">BACK</a>
				</div>
                <div class="col-md-3 text-center mb-4">
                <button onClick={handlePrint} type="button" className="btn btnx btn-dark">Download Report</button>
