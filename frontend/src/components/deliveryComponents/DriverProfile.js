...
function DriverProfile(){
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      {/*<li class="nav-item" key={user._id}>
      <select class="form-control form-control-sm"  value={user.Status} onChange={onlineStatus(key,e.target.value)} >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="/DriverySection">Deliver With FunkeyPop</a>
        </div>
      </li>
            ...
            {delivery && delivery.map((deliveryData, index) => (
              <tr key={index}>
                ...
                <td className="d-flex justify-content-between">
                  ...
                  <button className="btn btnx btn-dark" onClick={() => { Update(deliveryData._id); } }><span class="glyphicon glyphicon-pencil"></span></button>
